<%@ Page Language="C#" MasterPageFile="~/Master/DialogMasterPage.master" AutoEventWireup="true" CodeFile="SetupField_purchaseVendor.aspx.cs" Inherits="WKF_OptionalFields_SetupField_purchaseVendor" Title="" Culture="auto" meta:resourcekey="PageResource1" UICulture="auto" %>
...
<table width="100%" class="PopTable" cellspacing="1">
    ...
    <colgroup class="PopTableRightTD">	</colgroup>
    <tr>
        <td align="center" class="PopTableHeader" colspan="4"><center><asp:Label ID="lblSingleLine" runat="server" Text="廠商資訊" meta:resourcekey="lblSingleLineResource1"></asp:Label></center></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td colspan="3"><asp:TextBox ID="txtFieldDefault" runat="server" Width="100px" meta:resourcekey="txtFieldDefaultResource1"></asp:TextBox>
        <asp:CheckBox ID="cbxAllowMoidfyDefaultValue" runat="server" Text="允許修改預設值" meta:resourcekey="cbxAllowMoidfyDefaultValueResource1" Checked="True" /><asp:CustomValidator ID="CustomValidatorE" runat="server" ErrorMessage="CustomValidator" Display="Dynamic" meta:resourcekey="CustomValidatorEResource1"></asp:CustomValidator></td>
    </tr>
     <tr>
            <td>
