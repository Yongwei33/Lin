<%@ Page Language="C#" MasterPageFile="~/Master/DialogMasterPage.master" AutoEventWireup="true" CodeFile="SetupField_purchaseDetail.aspx.cs" Inherits="WKF_OptionalFields_SetupField_purchaseDetail" Title="" Culture="auto" meta:resourcekey="PageResource1" UICulture="auto" %>
...
<table width="100%" class="PopTable" cellspacing="1">
    ...
    <colgroup class="PopTableRightTD">	</colgroup>
    <tr>
        <td align="center" class="PopTableHeader" colspan="4"><center><asp:Label ID="lblSingleLine" runat="server" Text="採購明細" meta:resourcekey="lblSingleLineResource1"></asp:Label></center></td>
    </tr>
    <tr>
    ...
    <tr>
        <td  colspan="4" align="left"><asp:CheckBox ID="cbxAllowMoidfyDefaultValue" runat="server" Text="允許修改預設值" meta:resourcekey="cbxAllowMoidfyDefaultValueResource1" Checked="True" /><asp:CustomValidator ID="CustomValidatorE" runat="server" ErrorMessage="CustomValidator" Display="Dynamic" meta:resourcekey="CustomValidatorEResource1"></asp:CustomValidator></td>
    </tr>
     <tr>
            <td>
