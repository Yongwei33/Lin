...
<table width="100%" class="PopTable" cellspacing="1">
    ...
    <colgroup class="PopTableRightTD">	</colgroup>
    <tr>
        <td align="center" class="PopTableHeader" colspan="4"><center><asp:Label ID="lblSingleLine" runat="server" Text="請購明細" meta:resourcekey="lblSingleLineResource1"></asp:Label></center></td>
    </tr>
    <tr>
